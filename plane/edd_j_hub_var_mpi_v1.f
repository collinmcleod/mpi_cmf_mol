...
!
	I=ND*ND
	CALL MPI_ALLREDUCE(MPI_IN_PLACE,WRK_MAT,I,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
	DO J=VDST,VDEND
	  KI(:,J,1)=WRK_MAT(:,J)
	END DO
!
...
!
	I=(ND-1)*ND
	CALL MPI_ALLREDUCE(MPI_IN_PLACE,WRK_RHS,I,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
	DO J=VDST,VDEND
