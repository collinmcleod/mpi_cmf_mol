...
!	
	IF(ND .GT. ND_SM)THEN
	  ...
	  CALL MPI_ALLREDUCE(MPI_IN_PLACE,NEW_DATA,4*ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
	ELSE
...
!
	...
	CALL MPI_ALLREDUCE(MPI_IN_PLACE,THOM_VEC,I,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
