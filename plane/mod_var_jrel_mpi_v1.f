...
!
	  NTRI_VECS=5
	  VEC_LENGTH=NTRI_VECS*ND
	  IF(.NOT. ALLOCATED(TRI_VECS))THEN
	    ALLOCATE (TRI_VECS(ND,NTRI_VECS),STAT=IOS)
	    ALLOCATE (TRI_VECS_SAVE(ND,NTRI_VECS),STAT=IOS)
	  END IF
	  TRI_VECS=0.0_LDP
	  ...
	  DERIV_SCL_FAC(1:ND)=>TRI_VECS(1:ND,5)
!
	  N_SET_UP_VECS=11
	  ...
	  I=I+1; PSI(1:ND)=>SET_UP_VECS(1:ND,I)
	  I=I+1; PSIPREV(1:ND)=>SET_UP_VECS(1:ND,I)
	  I=I+1; W(1:ND)=>SET_UP_VECS(1:ND,I)
	  I=I+1; WPREV(1:ND)=>SET_UP_VECS(1:ND,I)
