...
!
	...
	CALL d_DERIVCHI_dCHI_MPI_V1(dCHIdR,CHI,R,DST,DEND,ND,METHOD)
...
!
	CALL MPI_ALLREDUCE(MPI_IN_PLACE,TRI_VECS,ND,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,IERR)
...
!
	CALL TUNE(1,'SOL_TX')
 	CALL dRHSdCHI_PP_MPI_V1(TX(1,1,1),SOURCE,CHI,DTAU,COH_VEC,JNU,F,R,DIFF,DBB,DST,DEND,ND)
