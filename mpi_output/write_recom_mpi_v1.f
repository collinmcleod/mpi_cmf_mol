...
<<<<<<< HEAD
	...
	1                       SCAT_SIZE,SCAT_DISP,MY_MPI_DP,IZERO,MPI_COMM_WORLD,IERR)
=======
	    CALL MPI_GATHERV(ATM(ID)%DIERECOM,SCAT_SIZE(MYPE),MPI_DOUBLE_PRECISION,ROOT(ID)%DIERECOM,
	1                       SCAT_SIZE,SCAT_DISP,MPI_DOUBLE_PRECISION,IZERO,MPI_COMM_WORLD,IERR)
	    CALL MPI_GATHERV(ATM(ID)%ADDRECOM,SCAT_SIZE(MYPE),MPI_DOUBLE_PRECISION,ROOT(ID)%ADDRECOM,
	1                       SCAT_SIZE,SCAT_DISP,MPI_DOUBLE_PRECISION,IZERO,MPI_COMM_WORLD,IERR)
	    CALL MPI_GATHERV(ATM(ID)%X_RECOM,SCAT_SIZE(MYPE),MPI_DOUBLE_PRECISION,ROOT(ID)%X_RECOM,
	1                       SCAT_SIZE,SCAT_DISP,MPI_DOUBLE_PRECISION,IZERO,MPI_COMM_WORLD,IERR)
	    CALL MPI_GATHERV(SE(ID)%STEQ_ADV,SCAT_SIZE(MYPE),MPI_DOUBLE_PRECISION,LOC_STEQ_ADV(1,ID),
	1                       SCAT_SIZE,SCAT_DISP,MPI_DOUBLE_PRECISION,IZERO,MPI_COMM_WORLD,IERR)
>>>>>>> galah/main
	  END IF
	END DO
