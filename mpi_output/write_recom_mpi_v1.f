...
!
	...
	1	                SCAT_SIZE,SCAT_DISP,MY_MPI_DP,IZERO,MPI_COMM_WORLD,IERR)
!
	    CALL MPI_GATHERV(ATM(ID)%MOL_DRXzV,SCAT_SIZE(MYPE),MY_MPI_DP,ROOT(ID)%MOL_DRXzV,
	1                       SCAT_SIZE,SCAT_DISP,MY_MPI_DP,IZERO,MPI_COMM_WORLD,IERR)
	    CALL MPI_GATHERV(ATM(ID)%MOL_CRXzV,SCAT_SIZE(MYPE),MY_MPI_DP,ROOT(ID)%MOL_CRXzV,
	1                       SCAT_SIZE,SCAT_DISP,MY_MPI_DP,IZERO,MPI_COMM_WORLD,IERR)	    
...
! 
	...
	1	   ROOT(ID)%CHG_PRXzV, ROOT(ID)%CHG_RRXzV,
	1          ROOT(ID)%MOL_DRXzV,ROOT(ID)%MOL_CRXzV, LOC_STEQ_ADV(:,ID),
