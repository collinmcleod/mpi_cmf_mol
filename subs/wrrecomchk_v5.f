...
C
C
	SUBROUTINE WRRECOMCHK_V5(PR,RR,CPR,CRR,CHG_PR,CHG_RR,ADVEC_RR,
...
C
	  ...
	  END IF
C
C Write out net X-ray recombinations from i+1 to i-1.  eg If NIV, net recom's from NV to NIII).
C
	  ...
	  END IF
C
C Write out net X-ray recombinations from i+2 to i. (eg If NIV, net ion's from NIV to NVI).
C
