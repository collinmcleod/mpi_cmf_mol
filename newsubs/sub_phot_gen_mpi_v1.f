...
!
	...
	INTEGER :: MPI_COMM_SHARMEM, PHOT_WIN
...
!
	DO I=1+MYPE,NLEVS,NTHR_PER_CORE
          IF(I .GT. NLEVS)EXIT
	  LOC_PHOT(I)=0.0_LDP
	END DO
	CALL MPI_WIN_FENCE(0,PHOT_WIN,IERR)
	CALL MPI_BARRIER(MPI_COMM_WORLD, IERR)
	NTHR_PER_CORE=(NLEVS-1)/NTHREAD+1
!
...
C
!	    DO I=NLEVS-MYPE,1,-NTHR_PER_CORE
!	      IF(I .LT. 1)EXIT
!
	    DO I=1+MYPE,NLEVS,NTHR_PER_CORE
	      IF(I .GT. NLEVS)EXIT
...
!
	...
	WRITE(6,*)'Exiting SU_PHOT_GEN',MYPE;FLUSH(UNIT=6)
!
	RETURN
	END
