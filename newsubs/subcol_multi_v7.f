...
!
	...
	1    COMPUTE_BA,FIXED_T,LAST_ITERATION,IS_MOL)
	USE SET_KIND_MODULE
	IMPLICIT NONE
!
! Altered 24-Oct-2023 - changed call to deal with molecular stuff, updated to v7
!
...
!
	...
	LOGICAL COMPUTE_BA,FIXED_T,LAST_ITERATION,IS_MOL
!
