...
!
	REAL(KIND=LDP) HN_S(N_S,DST:DEND),HNST_S(N_S,ND)
...
!
	END DO
 	CALL MPI_REDUCE(MPI_IN_PLACE,COOL,ND,MPI_DOUBLE_PRECISION,MPI_SUM,IZERO,MPI_COMM_WORLD,IERR)	
 	CALL MPI_REDUCE(MPI_IN_PLACE,CPR,ND,MPI_DOUBLE_PRECISION,MPI_SUM,IZERO,MPI_COMM_WORLD,IERR)	
 	CALL MPI_REDUCE(MPI_IN_PLACE,CRR,ND,MPI_DOUBLE_PRECISION,MPI_SUM,IZERO,MPI_COMM_WORLD,IERR)	
!
	RETURN
	END
