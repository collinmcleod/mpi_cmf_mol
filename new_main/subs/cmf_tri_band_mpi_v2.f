...
!
	  ...
	  CALL MPI_ALLREDUCE(MPI_IN_PLACE,OLD_EST,I,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
!
	  CALL GATHER_SELF_VEC_MPI_V1(ERR_EST,DST,DEND,ND)
	  J=0; CALL MPI_BCAST(ERR_EST,ND,MY_MPI_DP,J,MPI_COMM_WORLD,IERR)
	  IF(MYPE .EQ. 0)THEN
