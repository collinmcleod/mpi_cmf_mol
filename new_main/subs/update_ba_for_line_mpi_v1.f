	SUBROUTINE UPDATE_BA_FOR_LINE_MPI_V1(FL,FQW,FREQ_INDX,
...
!
	...
	1             BA_CHK_FAC,NION,NT,NUM_BNDS,DST,DEND,ND)
	    END IF
!
	    I=(DPTH_INDX-DST)*(DEND-DPTH_INDX)
	    IF(LST_ITERATION .AND. VERBOSE_OUTPUT .AND. .NOT. LAMBDA_ITERATION .AND. I .GE. 0)THEN
...
! Equilibrium equation, since this is automatically updated with the continuum.
!
