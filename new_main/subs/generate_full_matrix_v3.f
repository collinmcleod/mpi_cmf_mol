...
!
	...
	IF(USE_ELEC_HEAT_BAL .AND. DEPTH_INDX .LE. DEPTH_INDX_EHB)THEN
...
!
	...
	END IF
!
	IF(K .EQ. 50000 .AND. DIAG_BAND)THEN
...
!
	...
	END DO
!
! Write out diaginal part of BA matrix for debugging purposes. Simply
! set WRITE_INDX to 0 to avoid writes.
!
	K=DEPTH_INDX
	WRITE_INDX=0                      !; WRITE_INDX(1:4)=(/5,15,52,58/)
!	WRITE_INDX(1:3)=(/87,88,89/)
	DO I=1,NINDX
