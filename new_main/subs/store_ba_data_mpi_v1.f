...
C
	SUBROUTINE STORE_BA_DATA_MPI_V1(LU,NION,NUM_BANDS,COMPUTE_BA,FIXED_T,DESC)
	USE SET_KIND_MODULE
	USE MOD_CMFGEN
	USE STEQ_DATA_MOD
	USE MOL_RXN_MOD
...
C
	...
	1     ACCESS='SEQUENTIAL',STATUS='UNKNOWN',IOSTAT=IOS,ERR=500)
	  DO ID=1,NION
	    WRITE(LU,ERR=600,IOSTAT=IOS)SE(ID)%BA(:,:,:,DST:DEND)
	  END DO
...
C
	ENTRY INIT_BA_DATA_PNT_MPI_V1(LU,NION,NUM_BANDS,COMPUTE_BA,FIXED_T,DESC)
C
