...
!
	...
	CALL MPI_COMM_SIZE(MPI_COMM_WORLD,NTHREAD,IERR)
        IF(MYPE .EQ. 0)THEN
          WRITE(6,*)'MYPE=',MYPE,'NTHREAD=',NTHREAD
          WRITE(6,*)'MPI_DOUBLE_PRECISION=',MPI_DOUBLE_PRECISION
          WRITE(6,*)'MPI_INTEGER=',MPI_INTEGER
...
!
	...
	IF(DEND .GT. ND)DEND=ND	
!	CALL GET_DEPTH_DIMENSIONS(DST,DEND,NTHREAD,ND)
!
! Allocate ATM memory
!
	DO ID=1,NUM_IONS
