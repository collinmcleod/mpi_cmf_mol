...
!
          ...
          CHARACTER(10), ALLOCATABLE :: SPECIESID_LIST(:)
          CHARACTER(10), ALLOCATABLE :: SPECIESNAME_LIST(:)
          INTEGER, ALLOCATABLE :: EQSPECIES_LIST(:)
          INTEGER, ALLOCATABLE :: N_LVLS_SPECIES(:)
          REAL(KIND=LDP) :: RXN_SCALE_FAC
          REAL(KIND=LDP) :: CO_SCALE_FAC
          LOGICAL :: DO_NT
          REAL(KIND=LDP) :: SIL_COMP_SCL
!
