...
!
	  IF(.NOT. LST_DEPTH_ONLY)THEN
	    ...
	    CALL MPI_ALLREDUCE(MPI_IN_PLACE,CHI_C_EVAL,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
	    CALL MPI_ERR_CHECK(IERR,'MPI_ALLREDUCE -- COMP_OPAC')
	    ETA_C_EVAL(DST:DEND)=ETA(DST:DEND)
	    CALL MPI_ALLREDUCE(MPI_IN_PLACE,ETA_C_EVAL,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
	    CALL MPI_ERR_CHECK(IERR,'MPI_ALLREDUCE -- ETA_C_EVAL  -- COMP_OPAC')
	    CALL TUNE(2,'ALL_RED_COMP')
	    CALL TUNE(1,'IN_RED_COMP')
	    CALL MPI_ALLREDUCE(MPI_IN_PLACE,CHI_RAY,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
	    CALL MPI_ERR_CHECK(IERR,'MPI_ALLREDUCE -- CHI_RAY -- COMP_OPAC')
	    CALL MPI_ALLREDUCE(MPI_IN_PLACE,CHI_SCAT,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,IERR)
...
!                                              S= ZETA + THETA.J
	...
	END DO
	IF(.NOT. LST_DEPTH_ONLY)THEN
	  CALL MPI_ALLREDUCE(ZETA,TA,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,ierr)
	    CALL MPI_ERR_CHECK(IERR,'MPI_ALLREDUCE -- ZETA -- COMP_OPAC')
	  ZETA(1:ND)=TA(1:ND)
	  CALL MPI_ALLREDUCE(THETA,TA,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,ierr)
...
!
	...
	ELSE
	  CALL MPI_ALLREDUCE(ETA,ETA_CONT,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,ierr)
	    CALL MPI_ERR_CHECK(IERR,'MPI_ALLREDUCE -- ETA -- COMP_OPAC')
	  CALL MPI_ALLREDUCE(CHI,CHI_CONT,ND,MY_MPI_DP,MPI_SUM,MPI_COMM_WORLD,ierr)
