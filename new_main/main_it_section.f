...
!
	...
	CALL CHECK_VEC_NAN(BA_ED,I,'BA_ED(STOP)',J)
	CALL CHECK_VEC_NAN(BA_T,I,'BA_T(STOP)',J)
	I=NT*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_T_PAR,I,'BA_T_PAR(STOP)',J)
	CALL CHECK_VEC_NAN(BA_ADV_TERM,I,'BA_ADV_TERM(STOP)',J)
!
10000	CONTINUE
	IF(LST_ITERATION .AND. VERBOSE_OUTPUT)THEN
...
!
	...
	END IF
	I=NT*NUM_BNDS*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_ED,I,'AD_BA_ED(STOP)',J)
	CALL CHECK_VEC_NAN(BA_T,I,'AD-BA_T(STOP)',J)
	I=NT*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_T_PAR,I,'AD_BA_T_PAR(STOP)',J)
	CALL CHECK_VEC_NAN(BA_ADV_TERM,I,'AD_BA_ADV_TERM(STOP)',J)
!
...
!
	...
	I=NT*NUM_BNDS*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_ED,I,'EBA_ED(STOP)',J)
	CALL CHECK_VEC_NAN(BA_T,I,'EBA_T(STOP)',J)
	I=NT*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_T_PAR,I,'EBA_T_PAR(STOP)',J)
	CALL CHECK_VEC_NAN(BA_ADV_TERM,I,'EBA_ADV_TERM(STOP)',J)
!
...
!
	...
	CALL MPI_BARRIER(MPI_COMM_WORLD,IERR)
	I=NT*NUM_BNDS*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_ED,I,'XBA_ED(STOP)',J)
	CALL CHECK_VEC_NAN(BA_T,I,'XBA_T(STOP)',J)
	I=NT*(DEND-DST+1)
	CALL CHECK_VEC_NAN(BA_T_PAR,I,'XBA_T_PAR(STOP)',J)
	CALL CHECK_VEC_NAN(BA_ADV_TERM,I,'XBA_ADV_TERM(STOP)',J)
	CALL MPI_BARRIER(MPI_COMM_WORLD,IERR)
!
